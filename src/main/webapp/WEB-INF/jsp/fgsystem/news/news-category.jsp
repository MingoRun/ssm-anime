		    ...
		    jump:function(obj,first){  //jump - 切换分页的回调
		        ...
		        if(!first){
		          ...
		          //var conf ={"pageNum":obj.curr,"pageSize":obj.limit};
		        	window.location="${pageContext.request.contextPath }/toFrontNewsCategory.action?pageNum="+obj.curr+"&newsCategoryId="+${newsCategoryId}; 
		        }
		    }
		  });
	});
