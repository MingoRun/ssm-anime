...
<div class="page">
	...
	<nav class="breadcrumb"><!--当前页面所在位置-->
		现在位置<i class="fa fa-chevron-right" aria-hidden="true"></i><a href="${pageContext.request.contextPath }/toFrontIndex.action">首页</a><i class="fa fa-chevron-right" aria-hidden="true"></i><a href="${pageContext.request.contextPath }/toFrontNewsList.action">动漫新闻</a>			
	</nav><!--/当前页面所在位置-->
	<div class="content"><!--内容-->
		<div class="category"><!--分类-->
			<c:forEach items="${categories }" var="category">
				<div class="category-list">
					<a href="${pageContext.request.contextPath }/toFrontNewsCategory.action?newsCategoryId=${category.id }">${category.name }</a>
				</div>
				<div class="space"></div>
			</c:forEach>
			<div class="clear"></div>
			...
			<div class="entry-main"><!--5条新闻-->
				<c:forEach items="${newsPageInfo.list }" var="news">
					<div class="entry-home">
						...
						<span class="entry-category"><a href="${pageContext.request.contextPath }/toFrontNewsCategory.action?newsCategoryId=${news.getNewsCategory().getId() }">${news.getNewsCategory().getName() }</a></span>
		    ...
		    jump:function(obj,first){  //jump - 切换分页的回调
		        ...
		        if(!first){
		          ...
		          //var conf ={"pageNum":obj.curr,"pageSize":obj.limit};
		        	window.location="${pageContext.request.contextPath }/toFrontNewsList.action?pageNum="+obj.curr; 
		        	/* $.ajax({
		        		type:"POST",
		        		url:"${pageContext.request.contextPath }/fgsystem/newslist.action",
		        		async:true,
