...
<html>
  ...
  <body>
    <div class="x-body">
        <form id="chapterAddForm" class="layui-form" enctype="multipart/form-data" method="post" action="##" onsubmit="return false">
          ...
          <div class="layui-form-item">
           ...
           <div class="layui-form-item">
               ...
               <div class="layui-input-inline">
               	<input id="uploadChapterPage" name="uploadChapterPage" type="file" accept="image/*" multiple="multiple" style="display:none;" lay-verify="required" />
	...
	//表单 验证
   	layui.use(['form','layer','laydate'], function(){
        ...
        form.on('submit(add)',function(data){
        	var formData = new FormData(document.getElementById("chapterAddForm"));
   			...
   			$.ajax({
   				...
   				success:function(data){
   					...
   					if(data=="ERROR"){
         				 layui.use("layer",function(){
         					 var layer = layui.layer;
         					 layer.alert("漫画章节序号已存在，请重新输入！",{icon:2});
         				 });
         			 } 
   				}
   			});
