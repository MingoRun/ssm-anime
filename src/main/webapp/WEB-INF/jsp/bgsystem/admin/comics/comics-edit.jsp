...
<html>
  ...
  <body>
    <div class="x-body">
        <form id="comicsEditForm" class="layui-form" enctype="multipart/form-data" method="post" action="##" onsubmit="return false">
          <div class="layui-form-item" style="display: none;">
              <label for="comicsId" class="layui-form-label">
                  <span class="x-red">*</span>漫画编号
              </label>
              <div class="layui-input-inline">
                  <input type="text" id="comicsId" name="comicsId" required="" lay-verify="required|comicsName"
                  autocomplete="off" class="layui-input" value="${comics.comicsId }">
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${comics.comicsName }">
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${comics.comicsAuthor }">
              </div>
          </div>
         <div class="layui-form-item">
               ...
               <div class="layui-input-inline">
                   <img id="show-img" src="http://localhost:8081${comics.comicsImgUrl }" alt="图片预览" style="width:100px;height:100px;border:1px solid #F0F0F0;background-color:#f2f2f2" />
               </div>
               <div class="layui-input-inline">
              ...
              <div class="layui-input-inline">
                  <select id="comicsCategoryId" name="comicsCategoryId" lay-verify="required">
	                ...
	                <c:forEach items="${comicsCategoryList}" var="category">
	                	<option value="${category.comicsCategoryId }" <c:if test="${category.comicsCategoryId==comics.getComicsCategory().getComicsCategoryId() }">selected="selected"</c:if> >${category.comicsCategoryName }</option>
	                </c:forEach>
	              </select>
              </div>
          </div>
    ...
    <script>
        ...
        layui.use(['form','layer'], function(){
          ...
          form.on('submit(edit)', function(data){
        	 var formData = new FormData(document.getElementById("comicsEditForm"));
      	   	
     	   	 $.ajax({
     	   		 type:"POST", // 请求方式
     	   		 dataType:"text", //预期服务器返回的类型
     	   		 url: "${pageContext.request.contextPath}/updateComicsById.action", //访问路径
     	   		 contentType:false,
     	   		 processData: false, 
